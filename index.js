...
http('helloHttp', async (req, res) => {
  ...
  try {
    ...
    // - y=h*0.72 (At 72% screen height)
    // - borderw=4:bordercolor=black (Black border)
    const simpleFilter = "drawtext=text='Hi':fontsize=48:fontcolor=white:borderw=4:bordercolor=black:x=(w-text_w)/2:y=h*0.72";

    console.log('[TEST-RENDER] Running simple FFmpeg render...');
